...
| **Crédit** | Unité de valeur accordée par un abonnement et consommée lors des réservations selon des règles métier spécifiques | Confusion entre monnaie virtuelle et temps d'usage. Gestion de l'expiration et du report variable. | Un **Crédit** est un Value Object avec montant, type (heures, jours, euros), date d'expiration et règles de consommation. Les crédits sont gérés en portefeuille par l'Abonnement avec politique FIFO d'expiration. |
